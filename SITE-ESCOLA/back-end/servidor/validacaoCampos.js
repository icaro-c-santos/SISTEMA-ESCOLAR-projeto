...
const validate = [body("nome").isString().withMessage({ codigo: "01" , mensagem: "CAMPO NOME POSSUI O FORMATO INVALIDO!"}).notEmpty().withMessage({codigo: "02", mensagem: "CAMPO NOME VAZIO!"}),
...
export {validacaoCamposProfessor,validate}
